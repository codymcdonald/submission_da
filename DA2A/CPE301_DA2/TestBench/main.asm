...
;Set Initial Time
LDI R21,0x1A		;Load higher value to OCR1A
LDI R20,0x8C		;Load lower value to OCR1A
STS OCR1AH, R21
STS OCR1AL, R20
...
CPI R23, 1
BREQ LEDOFF
LDI R21,0x11		;Load higher value to OCR1A
LDI R20,0xB2		;Load lower value to OCR1A
STS OCR1AH, R21
STS OCR1AL, R20
LDI R23, 1
RET
